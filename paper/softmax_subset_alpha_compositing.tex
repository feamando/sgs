...
This is relevant to architectures that replace transformer attention with the alpha-compositing rendering equation from 3D Gaussian Splatting, as explored in the Semantic Gaussian Splatting (SGS) code repository~\citep{sgs-repo}. The theorem proves this replacement does not lose expressiveness.
