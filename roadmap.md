...
| 1-planck-1-4 | Planck 1.4 | model | in progress | 2026-04-27 | Conversation-memory blobs: per-turn blob writer + hybrid recency/similarity retrieval; flat cost-per-turn vs. growing context. 1.4.0 shipped 2026-05-19: DynamicBlobStore + TurnEncoder + HybridRetriever at src/conversation_memory.py, chat harness at scripts/chat_planck14.py. Eval infra (needle benchmark + cost measurement) in progress. Details at SETUP_202605.md section 8 |
...
| 6-raum-1-3 | Raum 1.3 | model | open | 2026-05-18 | Recursive semantic-to-geometric decomposition. Planck as contextual decomposer (castle → tower + gate + keep), blobs as distributions over compositions, GloVe for terminal primitives. Requires architecture redesign. Details at docs/plans/raum_13_plan.md |
...
| 10-raum-0-3 | Raum 0.3 | product | open | 2026-05-18 | Product demo of Raum 1.3 recursive decomposition architecture. Web demo showing compositional text-to-3D with hierarchical scene graphs. Depends on Raum 1.3 model track |
