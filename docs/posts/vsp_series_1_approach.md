...
First question, with a clear kill condition: can the bundle separate senses that text alone merges? Text embeddings score 0.13 on this, they fail, because the colliding word is the very thing that collapses the two meanings. The V+S+P bundle scores 0.37 across 20 polysemous words, entirely auto-derived, nothing hand-labeled. The senses pull apart, carried mostly by the visual signal (a picture of a bird and a picture of a construction crane are just far apart).
